...
export default function Recommendations({ websites, setWebsites }: RecommendationsProps) {
  ...
  const handleAddSite = (siteUrl: string) => {
    ...
    if (isProd !== undefined) {
      ...
      localStorage.setItem("focux-websites-2m31", JSON.stringify(newWebsites));
    }
  };
        ...
        {RECOMMENDED_SITES.map((site, index) => {
          ...
          return (
            <div
              ...
              style={index === RECOMMENDED_SITES.length - 1 ? { marginBottom: 0 } : undefined}
            >
              <div className="website-info">
                <img
                  ...
                  className="favicon"
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = `https://www.google.com/s2/favicons?domain=https://example.com`;
                  }}
                />
